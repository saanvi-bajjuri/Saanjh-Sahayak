...
🔁 **API Flow**
User uploads patient report via frontend
React sends request to Express backend
Backend forwards data to Flask ML service
Flask processes input and sends it to LLM
LLM returns disease risk prediction
Response is stored in MongoDB and displayed to user

👤 **User Flow**
Admin registers patients and caregivers
Caregivers upload patient reports
Doctors review reports and add medical notes
System predicts disease risks using LLM
Caregivers access recommendations and care plans
...
[(https://www.youtube.com/watch?v=dPFyAjMPBhw)]
